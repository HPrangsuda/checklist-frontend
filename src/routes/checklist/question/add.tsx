...
const formSteps: FormStep[] = [
  { id: 'form', title: 'Question Info', description: 'Fill in question details', required: true },
]
...
function RouteComponent() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response?.success) {
        toast.error('Create failed', { description: response?.message ?? 'Failed to create question' })
        return
      }
