...
import { Download, Edit, LogIn, Plus, RefreshCw, Trash, Upload } from "lucide-react"
                        ...
                        return (
                            <div key={activity.id} className="relative">
                                {index !== userActivities.length - 1 && (
                                    <div className="absolute left-4 top-8 w-px h-25 bg-gray-300" />
                                )}
                                <div className="flex items-start gap-3">
                                    <div className="relative">
                                        <div className="p-2 bg-white border-2 border-red-200 rounded-full">
                                            <ActionIcon className="h-3 w-3 text-red-600" />
                                        </div>
                                    </div>
