    ...
    <div className="space-y-4 mb-6">
        ...
        <CardHeader className="flex flex-row items-center justify-between flex-wrap gap-3 border-b px-5 py-4">
          <div>
            <CardTitle className="font-bold">
              ...
              {t('calibration_performance_dashboard') ?? 'Calibration Performance Dashboard'}
            </CardTitle>
            {!loading && (
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
        {[
          ...
          { label: t('total_overdue'),     value: String(filteredData.reduce((s, d) => s + d.totalOverdue, 0)), icon: <AlertCircle  className="w-7 h-7 text-red-400" />,             color: '' },
